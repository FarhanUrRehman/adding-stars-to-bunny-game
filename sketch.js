...
var sad_sound;
var eating_sound;
var star_1,star_2,starImg;
var emptyStar_1,oneStar,twoStar;
...
function setup() 
{
  ...
  mute_btn.mouseClicked(mute);
   ...
   blower.position(260,290);
   blower.size(100,100);
   blower.mouseClicked(airForce);
  ...
  star_display=createSprite(50,25,10,10);
  star_display.scale = 0.2

  star_display.addAnimation("emptyStar",emptyStar_1);
  ...
  star_1 = createSprite(300,20,10,10);
  star_1.addImage(starImg);
  star_1.scale = 0.02;

  star_2 = createSprite(80,350,10,10);
